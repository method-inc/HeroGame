...
declare module EndGate.Bounds {
    ...
    */
    class BoundingCircle extends Bounds.Abstractions.Bounds2d {  
        /**
...
declare module EndGate.Bounds {
    ...
    */
    class BoundingRectangle extends Bounds.Abstractions.Bounds2d {  
        /**
...
declare module EndGate.Collision {
    ...
    */
    class CollisionManager implements EndGate.IUpdateable {    
        /**
...
declare module EndGate.Graphics.Abstractions {
    ...
    */
    class Graphic2d implements EndGate.Rendering.IRenderable, EndGate.IMoveable, EndGate.IDisposable { 
        /**
